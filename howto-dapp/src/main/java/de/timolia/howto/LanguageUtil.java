...
public class LanguageUtil {
    ...
    private static ArrayList<LanguageString> getTranslations() {
        return new ArrayList<>() {{
            ...
            add(new LanguageString(Language.EN, "page.responsibilities.project-team-orga.apply.creator", "Staff selection creator"));
            add(new LanguageString(Language.DE, "page.responsibilities.project-team-orga.apply.developer", "Teamlerauswahl Developer"));
            add(new LanguageString(Language.EN, "page.responsibilities.project-team-orga.apply.developer", "Staff selection developer"));
            add(new LanguageString(Language.DE, "page.responsibilities.project-team-orga.apply.supporter", "Teamlerauswahl Supporter"));
            add(new LanguageString(Language.EN, "page.responsibilities.project-team-orga.apply.supporter", "Staff selection supporter"));
            add(new LanguageString(Language.DE, "page.responsibilities.project-team-orga.apply.supporter.desc", "Wenn es wieder daran geht, neue Supporter in unsere Reihen zu holen, kümmern sich diese Verantwortlichen darum."));
            add(new LanguageString(Language.EN, "page.responsibilities.project-team-orga.apply.supporter.desc", "When it comes to recruiting new supporters, those team members will take care of it."));
            ...
            add(new LanguageString(Language.DE, "page.responsibilities.communication-platforms.forums.general", "Forum Allgemein"));
            add(new LanguageString(Language.EN, "page.responsibilities.communication-platforms.forums.general", "Forum General"));
            add(new LanguageString(Language.DE, "page.responsibilities.communication-platforms.forums.player-reports", "Forum Spieler melden"));
            add(new LanguageString(Language.EN, "page.responsibilities.communication-platforms.forums.player-reports", "Forum Reports"));
            add(new LanguageString(Language.DE, "page.responsibilities.communication-platforms.forums.bug-reports", "Forum Bug melden"));
            add(new LanguageString(Language.EN, "page.responsibilities.communication-platforms.forums.bug-reports", "Forum Report bugs"));
            add(new LanguageString(Language.DE, "page.responsibilities.communication-platforms.forums.appeal", "Forum Entschuldigungen"));
            add(new LanguageString(Language.EN, "page.responsibilities.communication-platforms.forums.appeal", "Forum Appeals"));
            add(new LanguageString(Language.DE, "page.responsibilities.communication-platforms.forums.falsely-banned", "Forum Zu Unrecht gebannt"));
            add(new LanguageString(Language.EN, "page.responsibilities.communication-platforms.forums.falsely-banned", "Forum Falsely banned"));
