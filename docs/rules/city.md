...
(§5) ist strengstens Verboten und wird mit einem Bann bestraft.
...
Das absichtliche Ignorieren des Handelschats kann Konsequenzen nach sich ziehen.
...
und in allen anderen Baugebieten nach frühestens 90 Tagen ein. Joinst du nach Ablauf dieser Frist wieder auf den Server, so kannst du dein Grundstück wiederherstellen.
