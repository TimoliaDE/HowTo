...
Spiele alleine oder im Team und beweise dich gegenüber deinen Gegner:innen in 1vs1. Wähle eigene oder andere Kits und finde in fairen Kämpfen heraus, wer besser ist.
...
Fordere andere alleine oder in Teams heraus oder nimm an einem Turnier teil und beweise dich gegenüber anderen Spieler:innen.
...
- Mit einem Linksklick auf eine:n Spieler:in wird diese Person zum Duell herausgefordert, mit einem Rechtsklick versendest du eine Team-Einladung.
...
- Um noch schneller noch fairere Matches zu finden, kannst du in der globalen Warteschlange gegen die Spieler:innen auf allen Servern spielen.
...
Arbeite dich in unserem Ranked-System die Karriereleiter hinauf und erreiche den höchsten Rang des Servers. 
Insgesamt gibt es 17 Ränge, die es zu erreichen gilt. Alle besitzen in 1vs1 einen zugewiesenen Wert, die Ranked Punkte. 
...
Die genauen Punktegrenzen für die einzelnen Ränge kannst du ingame mit dem Befehl `/ranks` aufrufen. Beachte, dass die besten Ränge nur von einer bestimmte Anzahl an Spieler:innen gleichzeitig besetzt sein können. 
...
Du startest bei jedem Kit mit 0 Punkten. Für gewonnene Spiele bekommst Punkte gutgeschrieben, für verlorene abgezogen. Neben den Ranked Punkten haben alle Spieler:innen für jedes Kit auch einen Elo Wert. 
...
### Seasons
Am Ende jeder Season werden alle Ranked Ranglisten und Punkte zurückgesetzt und die Top Spieler:innen der letzten Season werden in der PvP Lobby angezeigt. Die gesamten Statistiken (auch deine) der letzten Seasons kannst du ingame mit `/season [Nummer]` aufrufen. 
...
Das Turnier wird gleichzeitig von eine:r Streamer:in live übertragen. Die jeweiligen Streamer:innen und die Kits werden auf [Twitter](https://twitter.com/TimoliaTeam) und im [Timolia-Discord](/discord/) angekündigt.
...
## Premium-Features
- Während normale Spieler:innen lediglich ein Kit speichern können, stehen Spieler:innen mit Premium je nach Rang bis zu 5 Slots zur Verfügung. Bei der Mapauswahl haben normale Spieler:innen Zugriff auf einen und Spieler:innen mit Premium je nach Rang bis auf 5 Slots.
- Des Weiteren können Spieler:innen mit Premium Turniere (`/create`) und Teams mit mehr als zwei Spieler:innen erstellen. Einige Ränge können sogar serverweite 1vs1-Turniere starten (`/create`).
- Spieler:innen mit Premium erhalten bis zu drei mal mehr Pixel.
