...
Fordere andere alleine oder in Teams heraus oder nimm an einem Turnier teil und beweise dich gegenüber anderen.
...
Nimmt der erste Platz das Risikomatch gegen die/den Streamer:in an und gewinnt es, kann dieser sogar 2 Monate gewinnen. Verliert er allerdings, bekommt er nur einen halben Monat.
...
## Premium-Features
- Während normale Spieler:innen lediglich ein Kit speichern können, stehen Premium-Spieler:innen je nach Rang bis zu 5 Slots zur Verfügung. Bei der Mapauswahl haben normale Spieler:innen Zugriff auf einen und Premiums je nach Rang bis auf 5 Slots.
