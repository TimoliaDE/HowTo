...
Spiele alleine oder im Team und beweise dich gegenüber dem gegnerischen Team in 1vs1. Wähle eigene oder andere Kits und finde in fairen Kämpfen heraus, wer von euch überlegen ist.
...
Fordere andere alleine oder in Teams heraus oder nimm an einem Turnier teil und beweise dich gegenüber anderen Spielenden.
...
- Mit einem Linksklick auf einen Spielenden wird diese Person zum Duell herausgefordert, mit einem Rechtsklick versendest du eine Team-Einladung.
...
- Mit einem Rechtsklick auf eine Person beobachtest du den Kampf aus deren Perspektive.
...
- Um noch schneller noch fairere Matches zu finden, kannst du in der globalen Warteschlange gegen die Spielenden auf allen Servern spielen.
...
Arbeite dich in unserem Ranked-System die Karriereleiter hinauf und erreiche den höchsten Rang des Servers. 
Insgesamt gibt es 17 Ränge, die es zu erreichen gilt. Alle besitzt in 1vs1 einen zugewiesenen Wert, die Ranked Punkte. 
Bei einem Sieg erhöhen sich diese, verlierst du ein Spiel, werden dir Punkte abgezogen. Dein Rang bestimmt sich aus der Höhe deiner Punkte. 
Die genauen Punktegrenzen für die einzelnen Ränge kannst du ingame mit dem Befehl `/ranks` aufrufen. Beachte, dass die besten Ränge nur von einer bestimmte Anzahl an Spielenden gleichzeitig besetzt sein können. 
So können nur 3 Spielende gleichzeitig Rang 17 sein, auch wenn mehr als 3 Spielende >8500 Punkte haben. Alle Infos zu deinem aktuellen Rang und deinen Punkteständen findest du unter `/season`.
...
| <b><span class='minecraft-gold'>15</span></b> | 7200 - 7799 | (max. 50 Spielende) |
| <b><span class='minecraft-darkaqua'>16</span></b> | 7800 - 8499 | (max. 10 Spielende) |
| <b><span class='minecraft-green'>17</span></b> | 8500+ | (max. 3 Spielende) |
...
Du startest bei jedem Kit mit 0 Punkten. Für gewonnene Spiele bekommst Punkte gutgeschrieben, für verlorene abgezogen. Neben den Ranked Punkten haben alle Spielende für jedes Kit auch einen Elo Wert. 
Dieser wird dir nicht angezeigt, sondern versucht im Hintergrund deine Spielstärke zu ermitteln. Wie groß die Differenz zwischen deinen Punkten und deiner Elo sowie der Elo des gegnerischen Teams ist, bestimmt, wie viele Punkte du für Sieg oder Niederlage dazugewinnst bzw. verlierst.
...
### Seasons
Am Ende jeder Season werden alle Ranked Ranglisten und Punkte zurückgesetzt und die Top Spielenden der letzten Season werden in der PvP Lobby angezeigt. Die gesamten Statistiken (auch deine) der letzten Seasons kannst du ingame mit `/season [Nummer]` aufrufen. 
...
## Winstreaks
Verdiene mit Winstreaks zusätzlich Pixel und kaufe dir mit diesen tolle Items im Pixelshop. Spielende mit [Premium](/ranks/premium/) erhalten mehr Pixel.
...
Das Turnier wird gleichzeitig mit einem Stream live übertragen. Die jeweiligen Streamenden und die Kits werden auf [Twitter](https://twitter.com/TimoliaTeam) und im [Timolia-Discord](/discord/) angekündigt.
Der erste Platz hat die Möglichkeit, den [MVP-Rang](/ranks/premium/) für einen Monat zu gewinnen. 
Nimmt der erste Platz das Risikomatch gegen die Person aus dem Stream an und gewinnt es, kann dieser sogar 2 Monate gewinnen. Verliert er allerdings, bekommt er nur einen halben Monat.
Außerdem erhalten die Top 3 eine Medaille sowie einen entsprechenden Subtitle. Alle Spielenden, die es bis auf den Finalserver schaffen, erhalten zudem 3 Tage Pro!
...
## Premium-Features
- Während normale Spielende lediglich ein Kit speichern können, stehen Spielenden mit Premium je nach Rang bis zu 5 Slots zur Verfügung. Bei der Mapauswahl haben normale Spielende Zugriff auf einen und Spielende mit Premium je nach Rang bis auf 5 Slots.
- Des Weiteren können Spielende mit Premium Turniere (`/create`) und Teams mit mehr als zwei Spielenden erstellen. Einige Ränge können sogar serverweite 1vs1-Turniere starten (`/create`).
- Spielende mit Premium erhalten bis zu drei mal mehr Pixel.
- Setze dir im Kitbereich mit `/hat` Items in deiner Hand auf den Kopf.
- Wähle mit `/team setcolor` deine Teamfarbe aus.
- Fordere mit `/bestofx Spieler> <Anzahl>` andere Spielende zu einem Best of 3 oder Best of 5 heraus.
- Werde mit `/togglerank` als normale Person angezeigt.
...
| Befehl | Funktion |
| ------ | -------- |
| `/challenge <Name>`, `/c`       | Fordert andere Spielende zu einem Duell heraus |
| `/compare <Name> <Name>`        | Zeigt die Kampfstatistik zweier Spielenden an |
...
| `/kit <Name(:1/2/3/4/5)>`       | Wählt das Kit von anderen Spielenden aus |
...
| `/stats <Name>`                 | Zeigt dir die Stats von anderen Spielenden an |
