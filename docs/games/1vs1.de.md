...
## FFA
In Turnieren steht es den erstellern offen ein FFA Turnier zu erstellen. Wie es der Name bereits beinhaltet ist dies "free for all", somit ist es
nicht gestattes anderen Spielern in jeglicher form zu helfen. Somit wird Teaming aktiv verfolgt und geahndet.
