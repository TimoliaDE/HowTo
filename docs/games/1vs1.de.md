...
Dabei erhalten sie mit einem neuen Leben zwar eine weitere Chanche, bekommen allerdings keine neuen Materialien zur verfügung gestellt. Daher ist die tacktische Verteilung und Nutzung des Equipments ein wichtiger
bestandteil des Spieles. Wie bereits der Name impliziert kämpft jeder Spieler alleine gegen die Anderen, darum ist jegliche Form von unterstützung oder bevorzugung eines anderen Gegners währned des gesammten Turniers verboten. 
