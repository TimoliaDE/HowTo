...
## Ranking-System
- In den Warteschlangen-Einstellung kann man einstellen, ob man Ranked oder Unranked-Matches spielen will.
- Ranked-Matches führen zur Einordnung in das Rangsystem, welches mit 0 als niedrigstem Rang beginnt und bis zum 16. Rang reicht
- UNVOLLSTÄÄÄÄÄÄÄNDIG (Befehle fürs Update müssen auch noch hin)
