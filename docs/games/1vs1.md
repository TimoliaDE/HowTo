...
- Erzwinge das Ende eines Kampfes mit `/endmatch`. Es gewinnt, wer in den letzten 30 Sekunden im Durchschnitt näher an der Mitte der Arena war. Mehr Infos dazu findest du [hier](#endmatch).
...
Das Turnier wird gleichzeitig von einem Streamer live übertragen. Die jeweiligen Streamer und Kits werden auf [Twitter](https://twitter.com/TimoliaTeam) angekündigt.
...
- Setzte dir im Kitbereich mit `/hat` Items in deiner Hand auf den Kopf.
