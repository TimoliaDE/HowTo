Hier werden alle Änderungen rund um Timolia dargestellt. 
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| 11.04.17 | HowTo | <span style="color:#199F29">Added</span> | Changelog hinzugefügt | Alle Änderungen rund um Timolia werden nun in einem Changelog festgehalten. | Tedget, Thomasch, Caelis
